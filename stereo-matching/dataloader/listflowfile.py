...
def dataloader(filepath):
    ...
    monkaa_path = "/data/changty/SceneFlow_archive/Monkaa/frames_cleanpass"
    monkaa_disp = "/data/changty/SceneFlow_archive/Monkaa/disparity"
    ...
    for dd in monkaa_dir:
        ...
        for img in right_imgs:
            ...
            if is_image_file(img_path):
                if img_path != '/data/changty/SceneFlow_archive/Monkaa/frames_cleanpass/family_x2/right/0025.png':
    ...
    flying_path = "/data/changty/SceneFlow_archive/FlyingThings3D/frames_cleanpass"
    flying_disp = "/data/changty/SceneFlow_archive/FlyingThings3D/disparity"
    ...
    driving_dir = "/data/changty/SceneFlow_archive/Driving/frames_cleanpass/"
    driving_disp = "/data/changty/SceneFlow_archive/Driving/disparity/"
