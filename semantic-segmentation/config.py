...
__C.DATASET.CITYSCAPES_DIR = '/data/changty/DG-segment-dataset/cityscapes' 
#SDC Augmented Cityscapes Dir Location
__C.DATASET.CITYSCAPES_AUG_DIR = ''
#Mapillary Dataset Dir Location
__C.DATASET.MAPILLARY_DIR = '/data/changty/DG-segment-dataset/mapillary' 
#GTAV, BDD100K Dataset Dir Location
__C.DATASET.GTAV_DIR = '/data/changty/DG-segment-dataset/gtav'
__C.DATASET.BDD_DIR = '/data/changty/DG-segment-dataset/BDD-100K/bdd100k'
__C.DATASET.ACDC_DIR = '/ssd/yyzhao/data/ACDC' 
#Synthia Dataset Dir Location
__C.DATASET.SYNTHIA_DIR = '/data/changty/DG-segment-dataset/synthia' 
